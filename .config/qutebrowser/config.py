...
## qutebrowser`.
## Type: Dict
c.url.searchengines = {"DEFAULT": "https://search.brave.com/search?q={}","aw": "https://wiki.archlinux.org/?search={}", "ddg": "https://duckduckgo.com/?q={}"}
...
#config.bind('<Ctrl-O>', 'config-cycle statusbar.show always never')
#config.bind('<Ctrl-O>', 'config-cycle tabs.show always never')
config.bind('<Ctrl-O>', 'config-cycle statusbar.show always never;; config-cycle tabs.show always never')
